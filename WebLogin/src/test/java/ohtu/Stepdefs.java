...
public class Stepdefs {
    ...
    @Given("^user with username \"([^\"]*)\" with password \"([^\"]*)\" is unsuccessfully created$")
    public void user_with_username_with_password_is_unsuccessfully_created(String username, String password) throws Throwable {
        new_user_is_selected();
        createNewUserWith(username, password, password);
    }
